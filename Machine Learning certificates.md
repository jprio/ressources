# Professional Certificate Program in Machine Learning & Artificial Intelligence By MIT
...
# Machine Learning Certificate By Harvard
...
* classification: perceptrons, support vector machines (SVMs), Gaussian discriminant analysis (including linear discriminant analysis, LDA, and quadratic discriminant analysis, QDA), 
logistic regression, decision trees, neural networks, convolutional neural networks, boosting, nearest neighbor search;
